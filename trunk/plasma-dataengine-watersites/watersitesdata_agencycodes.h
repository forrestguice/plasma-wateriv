...
#ifndef WATERSITESDATAAGENCYCODES_H
#define WATERSITESDATAAGENCYCODES_H
 
#include "watersitesdata.h"
#include <QDomElement>

/**
    An implementation of WaterSitesData; the "agencycodes" xml format (homebrew).
*/
class WaterSitesDataAgencyCodes  : public WaterSitesData
{
    public:
