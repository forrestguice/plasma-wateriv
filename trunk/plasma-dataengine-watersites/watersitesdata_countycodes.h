...
#ifndef WATERSITESDATACOUNTYCODES_H
#define WATERSITESDATACOUNTYCODES_H
 
#include "watersitesdata.h"
#include <QDomElement>

/**
    An implementation of WaterSitesData; the "county" xml format (homebrew).
*/
class WaterSitesDataCountyCodes  : public WaterSitesData
{
    public:
