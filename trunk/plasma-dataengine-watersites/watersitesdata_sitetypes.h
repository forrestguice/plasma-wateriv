...
#ifndef WATERSITESDATASITETYPES_H
#define WATERSITESDATASITETYPES_H
 
#include "watersitesdata.h"
#include <QDomElement>

/**
    An implementation of WaterSitesData; the "sitetypes" xml format (homebrew).
*/
class WaterSitesDataSiteTypes  : public WaterSitesData
{
    public:
